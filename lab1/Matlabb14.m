...
hs = [15.5 18.1 18.5 16.3 14.0 11.5];
%Datumen uttryckt i dag på året:
nrday = @(s,t) day(datetime(2019,s,t),'dayofyear');
...
% Normvärdet för första modellen är bättre ty mindre avstånd från kurvan
% till X
